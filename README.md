...
- Interactive Hover Tooltips: For web-based college dashboards, utilize interactive tooltips. While the static slice might only display a clean percentage like "15%", hovering over the slice should reveal a pop-up box with exact, real-time data (e.g., Faculty of Science: 1,452 Students), perfectly balancing macro proportions with micro details.
