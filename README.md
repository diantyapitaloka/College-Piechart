...
- Color Theory for Categorization: Using distinct, high-contrast colors for each faculty prevents the slices from blending together. Hence, A well-chosen palette ensures that even without reading labels, viewers can distinguish between different academic fields.
